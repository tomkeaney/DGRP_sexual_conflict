...
**Table S2** / **Supplementary dataset S1**: $R$ partitions and associated evidence ratios for the organismal level trait dataset. Data can be downloaded as a `.csv` file from the [github repository](https://github.com/tomkeaney/DGRP_sexual_conflict) associated with this project.
```{r}
