...
**Or we just do male mean vale / female mean value**

- This model is not coded correctly. When we predict the mean trait value for each sex we get near mirrored values. The smaller sex returns a negative value, the larger sex returns a near mirrored positive value. **Why?**
