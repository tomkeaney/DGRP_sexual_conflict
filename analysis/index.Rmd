...
## Ideas
[Here](Ideas.html) I document research questions that we can potentially test with this data-set
...
## SNP-heritabilities and the Robertson-Price Identity using `GCTA`

The code used to run GREML models to estimate SNP heritability and selection differentials [here](SNP_heritabilities.html)

## Results of the `GCTA` analyses
Graphs and tables relating to the output of `GCTA` [here](GCTA_results.html)
